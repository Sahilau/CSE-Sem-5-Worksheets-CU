...
template <class T> Stack<T>::Stack() { top = -1; } template <class T> void Stack<T>::push(T k)
{
if (isFull()) {
cout << "Stack is full\n";
}
...
{
T top_element = st[top]; return top_element;
} int main()
{
...
integer_stack.push(90); 
string_stack.push("Sahil"); 
string_stack.push("Kaundal");
